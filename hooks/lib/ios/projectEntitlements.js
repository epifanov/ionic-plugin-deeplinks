 ...
 */
function generateEntitlements(cordovaContext, deeplinkHost) {
  context = cordovaContext;

  var currentEntitlements = getEntitlementsFileContent();
  var newEntitlements = injectDeeplinkHost(currentEntitlements, deeplinkHost);
 ...
 */
function injectDeeplinkHost(currentEntitlements, deeplinkHost) {
  var newEntitlements = currentEntitlements;
  var content = generateAssociatedDomainsContent(deeplinkHost);
